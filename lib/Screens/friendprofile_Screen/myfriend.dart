...
class _FriendHomeScreenState extends State<FriendHomeScreen> with SingleTickerProviderStateMixin{
      ...
      appBar: AppBar(
        ...
        bottom:  TabBar(
          ...
          tabs: const [
            ...
            Tab(child: Text('Request',style: TextStyle(color: Colors.white),),),
            Tab(child: Text('Upcomming',style: TextStyle(color: Colors.white),),),
